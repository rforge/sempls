...
l2cor(l)
l <- c(.7, .8, .5)
#l <- l/norm(as.matrix(l), "F")

dat2 <- cbind(x1=addEps(l[1]*y1, n=this_n),
              x2=addEps(l[2]*y1, n=this_n),
              x3=addEps(l[3]*y1, n=this_n))
...
sd(eps(.8, n=100000))
lv1a1 <- structure(dat2_fa1$scores,
                   dimnames=list(dimnames(dat2_fa1$scores)[[1]], "FA"))
